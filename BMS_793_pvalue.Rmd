...
* How does sample size effect p values? 
...
for (i in 1:10){
samp <- rnorm(n,mean=mu,sd=1)  # generate some data assuming null is true
...
```{r}
NHANES <- read.csv("/Volumes/New Volume/flash_2.8.2019/BMS_793B/data/NHANES.csv")
